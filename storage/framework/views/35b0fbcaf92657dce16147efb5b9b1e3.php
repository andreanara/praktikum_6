                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors->has('firstName')): ?> is-invalid <?php endif; ?>" type="text"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors->has('lastName')): ?> is-invalid <?php endif; ?>" type="text"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php if($errors->has('age')): ?> is-invalid <?php endif; ?>" type="text"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Documents\TUGAS KULIAH\SMT 4\Pemrograman Framework\Praktikum 4\laravelController\resources\views/employee/create.blade.php ENDPATH**/ ?>